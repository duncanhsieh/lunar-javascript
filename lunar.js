(function (root, factory) {
  ...
  var Solar = (function () {
    ...
    var _fromYmdHms = function (y, m, d, hour, minute, second) {
      ...
      if (1582 === y && 10 === m) {
        if (d > 4 && d < 15) {
          throw new Error(
            'wrong solar year ' + y + ' month ' + m + ' day ' + d
          );
        }
      }
      if (m < 1 || m > 12) {
      ...
      return {
        ...
        /**
         * 獲取當天的陽歷周
         * @param start 星期幾作為一周的開始，1234560分別代表星期一至星期天
         */
        getSolarWeek: function (start) {
          return SolarWeek.fromYmd(
            this._p.year,
            this._p.month,
            this._p.day,
            start
        ...
        getFestivals: function () {
          ...
          if (
            this._p.day + 7 >
            SolarUtil.getDaysOfMonth(this._p.year, this._p.month)
          ) {
        ...
        nextMonth: function (months) {
          ...
          var month = SolarMonth.fromYm(this._p.year, this._p.month).next(
            months
          );
          var y = month.getYear();
    ...
    var _fromBaZi = function (
      ...
      // 月天幹要一致
      if (
        ((LunarUtil.index(yearGanZhi.substring(0, 1), LunarUtil.GAN, -1) + 1) *
          2 +
          m) %
          10 !==
          ...
          if (solarTime.getYear() >= baseYear) {
            ...
            for (var i = 0, j = hours.length; i < j; i++) {
              ...
              if (d === 0 && hour === solarTime.getHour()) {
                // 如果正好是節令當天，且小時和節令的小時數相等的極端情況，把分鐘和秒鐘帶上
  ...
  var Lunar = (function () {
    ...
    var _computeMonth = function (o, solar) {
      ...
      //序號：大雪以前-3，大雪到小寒之間-2，小寒到立春之間-1，立春之後0
      var index = -3;
      for (i = 0; i < size; i += 2) {
    ...
    var _fromYmdHms = function (
      ...
      if (null == m) {
        throw new Error(
          'wrong lunar year ' + lunarYear + ' month ' + lunarMonth
        );
      }
      if (lunarDay < 1) {
    ...
    var _new = function (year, month, day, hour, minute, second, solar, ly) {
      ...
      return {
        ...
        getOtherFestivals: function () {
          ...
          if (
            this._p.solar.toYmd() ===
            this._getJieQiSolar(I18n.getMessage('jq.qingMing')).next(-1).toYmd()
          ) {
            l.push('寒食節');
          }
        ...
        getTimeNineStar: function () {
          ...
          if (
            (solarYmd >=
              this._getJieQiSolar(I18n.getMessage('jq.dongZhi')).toYmd() &&
              solarYmd <
                this._getJieQiSolar(I18n.getMessage('jq.xiaZhi')).toYmd()) ||
            solarYmd >= this._getJieQiSolar('DONG_ZHI').toYmd()
          ) {
            asc = true;
          }
        ...
        toFullString: function () {
          ...
          s += ' ' + this.getTimeZhi() + '(' + this.getTimeShengXiao() + ')時';
          s +=
            ' 納音[' +
            this.getYearNaYin() +
            ' ' +
        ...
        getShuJiu: function () {
          ...
          if (currentDay.isBefore(startDay)) {
            ...
            startDay = Solar.fromYmd(
              start.getYear(),
              start.getMonth(),
              start.getDay()
            );
          }
          var endDay = Solar.fromYmd(
            start.getYear(),
            start.getMonth(),
            start.getDay()
          ).next(81);
        ...
        getWuHou: function () {
          ...
          var current = Solar.fromYmd(
            this._p.solar.getYear(),
            this._p.solar.getMonth(),
            this._p.solar.getDay()
          );
          var startSolar = jieQi.getSolar();
          var start = Solar.fromYmd(
            startSolar.getYear(),
            startSolar.getMonth(),
            startSolar.getDay()
          );
          ...
          return LunarUtil.WU_HOU[
            (jq.index * 3 + index) % LunarUtil.WU_HOU.length
          ];
        },
        getHou: function () {
          var jieQi = this.getPrevJieQi(true);
  ...
  var SolarWeek = (function () {
    ...
    var _fromYmd = function (y, m, d, start) {
      ...
      return {
        ...
        /**
         * 獲取當前日期是在當月第幾周
         * @return number 周序號，從1開始
         */
        getIndex: function () {
          var offset =
            Solar.fromYmd(this._p.year, this._p.month, 1).getWeek() -
            this._p.start;
          if (offset < 0) {
            offset += 7;
          }
        ...
        getIndexInYear: function () {
          var offset =
            Solar.fromYmd(this._p.year, 1, 1).getWeek() - this._p.start;
          if (offset < 0) {
            offset += 7;
          }
          return Math.ceil(
            (SolarUtil.getDaysInYear(this._p.year, this._p.month, this._p.day) +
              offset) /
              7
          );
        },
        /**
         * 周推移
         * @param weeks 推移的周數，負數為倒推
         * @param separateMonth 是否按月單獨計算
         * @return object 推移後的陽歷周
         */
      ...
      return {
        ...
        getWeeks: function (start) {
          ...
          while (true) {
            ...
            var firstDay = week.getFirstDay();
            if (
              firstDay.getYear() > this._p.year ||
              firstDay.getMonth() > this._p.month
            ) {
              break;
            }
          }
  ...
  var LunarYear = (function () {
    ...
    var _LEAP_11 = [
      75, 94, 170, 265, 322, 398, 469, 553, 583, 610, 678, 735, 754, 773, 849,
      887, 936, 1050, 1069, 1126, 1145, 1164, 1183, 1259, 1278, 1308, 1373,
    ...
    var _fromYear = function (lunarYear) {
      ...
      return {
        ...
        getGongZhu: function () {
          return this._getZaoByZhi(11, '幾屠共豬');
        },
        getJiaTian: function () {
        ...
        _compute: function () {
          ...
          for (i = 0; i < 15; i++) {
            ...
            this._p.months.push(
              LunarMonth._(y, mc, dayCounts[i], hs[i] + Solar.J2000, index)
            );
            index++;
          }
          return this;
  ...
  var LunarMonth = (function () {
    ...
    var _new = function (
      ...
      return {
        ...
        getGanIndex: function () {
          var offset =
            ((LunarYear.fromYear(this._p.year).getGanIndex() + 1) % 5) * 2;
  ...
  var ShouXingUtil = (function () {
    ...
    return {
      ...
      DT_AT: [
        ...
        51.0, 1.29, -0.026, 0.0032, 2000, 63.87, 0.1, 0, 0, 2005, 64.7, 0.21, 0,
        0, 2012, 66.8, 0.22, 0, 0, 2018, 69.0, 0.36, 0, 0, 2028, 72.6,
      ],
      XL0: [
      ...
      QI_KB: [
        1640650.479938, 15.218425, 1642476.703182, 15.21874996, 1683430.515601,
        15.218750011, 1752157.640664, 15.218749978, 1807675.003759,
        15.218620279, 1883627.765182, 15.218612292, 1907369.1281, 15.218449176,
        1936603.140413, 15.218425, 1939145.52418, 15.218466998, 1947180.7983,
        15.218524844, 1964362.041824, 15.218533526, 1987372.340971,
        15.218513908, 1999653.819126, 15.218530782, 2007445.469786,
        15.218535181, 2021324.917146, 15.218526248, 2047257.232342,
        15.218519654, 2070282.898213, 15.218425, 2073204.87285, 15.218515221,
        2080144.500926, 15.218530782, 2086703.688963, 15.218523776,
        2110033.182763, 15.218425, 2111190.300888, 15.218425, 2113731.271005,
        15.218515671, 2120670.840263, 15.218425, 2123973.309063, 15.218425,
        2125068.997336, 15.218477932, 2136026.312633, 15.218472436,
        2156099.495538, 15.218425, 2159021.324663, 15.218425, 2162308.575254,
        15.218461742, 2178485.706538, 15.218425, 2178759.662849, 15.218445786,
        2185334.0208, 15.218425, 2187525.481425, 15.218425, 2188621.191481,
        15.218437494, 2322147.76,
      ],
      QB: _decode(
      ...
      saLonT2: function (w) {
        ...
        t +=
          (w -
            ShouXingUtil.eLon(t, 8) -
            Math.PI +
            (20.5 + 17.2 * Math.sin(2.1824 - 33.75705 * t)) /
              this.SECOND_PER_RAD) /
          v;
        return t;
      },
      ...
      calcQi: function (jd) {
        ...
        if (jd < f1 || jd >= f3) {
          ...
          d =
            this.QI_KB[i] +
            this.QI_KB[i + 1] *
              Math.floor((jd + pc - this.QI_KB[i]) / this.QI_KB[i + 1]);
          d = Math.floor(d + 0.5);
          if (d === 1683460) {
            d++;
          }
  ...
  var SolarUtil = (function () {
    return {
      ...
      OTHER_FESTIVAL: {
        ...
        '3-14': ['馬克思逝世紀念日', '白色情人節'],
        '3-17': ['國際航海日'],
        '3-18': ['全國科技人才活動日', '全國愛肝日'],
        '3-20': ['國際幸福日'],
        '3-21': ['世界森林日', '世界睡眠日', '國際消除種族歧視日'],
        '3-22': ['世界水日'],
        '3-23': ['世界氣象日'],
        '3-24': ['世界防治結核病日'],
        '3-29': ['中國黃花崗七十二烈士殉難紀念日'],
        '4-2': ['國際兒童圖書日', '世界自閉癥日'],
        '4-4': ['國際地雷行動日'],
        '4-7': ['世界衛生日'],
        '4-8': ['國際珍稀動物保護日'],
  ...
  var LunarUtil = (function () {
    return {
      ...
      XIU_SONG: {
        '{xx.jiao}':
          '角星造作主榮昌，外進田財及女郎，嫁娶婚姻出貴子，文人及第見君王，惟有埋葬不可用，三年之後主瘟疫，起工修築墳基地，堂前立見主人兇。',
        '{xx.kang}':
          '亢星造作長房當，十日之中主有殃，田地消磨官失職，接運定是虎狼傷，嫁娶婚姻用此日，兒孫新婦守空房，埋葬若還用此日，當時害禍主重傷。',
        '{xx.di}':
          '氐星造作主災兇，費盡田園倉庫空，埋葬不可用此日，懸繩吊頸禍重重，若是婚姻離別散，夜招浪子入房中，行船必定遭沈沒，更生聾啞子孫窮。',
        '{xx.fang}':
          '房星造作田園進，錢財牛馬遍山崗，更招外處田莊宅，榮華富貴福祿康，埋葬若然用此日，高官進職拜君王，嫁娶嫦娥至月殿，三年抱子至朝堂。',
        '{xx.xin}':
          '心星造作大為兇，更遭刑訟獄囚中，忤逆官非宅產退，埋葬卒暴死相從，婚姻若是用此日，子死兒亡淚滿胸，三年之內連遭禍，事事教君沒始終。',
        '{xx.tail}':
          '尾星造作主天恩，富貴榮華福祿增，招財進寶興家宅，和合婚姻貴子孫，埋葬若能依此日，男清女正子孫興，開門放水招田宅，代代公侯遠播名。',
        '{xx.ji}':
          '箕星造作主高強，歲歲年年大吉昌，埋葬修墳大吉利，田蠶牛馬遍山崗，開門放水招田宅，篋滿金銀谷滿倉，福蔭高官加祿位，六親豐祿樂安康。',
        '{xx.dou}':
          '鬥星造作主招財，文武官員位鼎台，田宅家財千萬進，墳堂修築貴富來，開門放水招牛馬，旺蠶男女主和諧，遇此吉宿來照護，時支福慶永無災。',
        '{xx.niu}':
          '牛星造作主災危，九橫三災不可推，家宅不安人口退，田蠶不利主人衰，嫁娶婚姻皆自損，金銀財谷漸無之，若是開門並放水，牛豬羊馬亦傷悲。',
        '{xx.nv}':
          '女星造作損婆娘，兄弟相嫌似虎狼，埋葬生災逢鬼怪，顛邪疾病主瘟惶，為事遭官財失散，瀉利留連不可當，開門放水用此日，全家財散主離鄉。',
        '{xx.xu}':
          '虛星造作主災殃，男女孤眠不一雙，內亂風聲無禮節，兒孫媳婦伴人床，開門放水遭災禍，虎咬蛇傷又卒亡，三三五五連年病，家破人亡不可當。',
        '{xx.wei}':
          '危星不可造高樓，自遭刑吊見血光，三年孩子遭水厄，後生出外永不還，埋葬若還逢此日，周年百日取高堂，三年兩載一悲傷，開門放水到官堂。',
        '{xx.shi}':
          '室星修造進田牛，兒孫代代近王侯，家貴榮華天上至，壽如彭祖八千秋，開門放水招財帛，和合婚姻生貴兒，埋葬若能依此日，門庭興旺福無休。',
        '{xx.qiang}':
          '壁星造作主增財，絲蠶大熟福滔天，奴婢自來人口進，開門放水出英賢，埋葬招財官品進，家中諸事樂陶然，婚姻吉利主貴子，早播名譽著祖鞭。',
        '{xx.kui}':
          '奎星造作得禎祥，家內榮和大吉昌，若是埋葬陰卒死，當年定主兩三傷，看看軍令刑傷到，重重官事主瘟惶，開門放水遭災禍，三年兩次損兒郎。',
        '{xx.lou}':
          '婁星修造起門庭，財旺家和事事興，外進錢財百日進，一家兄弟播高名，婚姻進益生貴子，玉帛金銀箱滿盈，放水開門皆吉利，男榮女貴壽康寧。',
        '{xx.vei}':
          '胃星造作事如何，家貴榮華喜氣多，埋葬貴臨官祿位，夫婦齊眉永保康，婚姻遇此家富貴，三災九禍不逢他，從此門前多吉慶，兒孫代代拜金階。',
        '{xx.mao}':
          '昴星造作進田牛，埋葬官災不得休，重喪二日三人死，盡賣田園不記增，開門放水招災禍，三歲孩兒白了頭，婚姻不可逢此日，死別生離是可愁。',
        '{xx.bi}':
          '畢星造作主光前，買得田園有余錢，埋葬此日添官職，田蠶大熟永豐年，開門放水多吉慶，合家人口得安然，婚姻若得逢此日，生得孩兒福壽全。',
        '{xx.zi}':
          '觜星造作有徒刑，三年必定主伶丁，埋葬卒死多因此，取定寅年使殺人，三喪不止皆由此，一人藥毒二人身，家門田地皆退敗，倉庫金銀化作塵。',
        '{xx.can}':
          '參星造作旺人家，文星照耀大光華，只因造作田財旺，埋葬招疾哭黃沙，開門放水加官職，房房子孫見田加，婚姻許遁遭刑克，男女朝開幕落花。',
        '{xx.jing}':
          '井星造作旺蠶田，金榜題名第一光，埋葬須防驚卒死，狂顛風疾入黃泉，開門放水招財帛，牛馬豬羊旺莫言，貴人田塘來入宅，兒孫興旺有余錢。',
        '{xx.gui}':
          '鬼星起造卒人亡，堂前不見主人郎，埋葬此日官祿至，兒孫代代近君王，開門放水須傷死，嫁娶夫妻不久長，修土築墻傷產女，手扶雙女淚汪汪。',
        '{xx.liu}':
          '柳星造作主遭官，晝夜偷閉不暫安，埋葬瘟惶多疾病，田園退盡守冬寒，開門放水遭聾瞎，腰駝背曲似弓彎，更有棒刑宜謹慎，婦人隨客走盤桓。',
        '{xx.xing}':
          '星宿日好造新房，進職加官近帝王，不可埋葬並放水，兇星臨位女人亡，生離死別無心戀，要自歸休別嫁郎，孔子九曲殊難度，放水開門天命傷。',
        '{xx.zhang}':
          '張星日好造龍軒，年年並見進莊田，埋葬不久升官職，代代為官近帝前，開門放水招財帛，婚姻和合福綿綿，田蠶人滿倉庫滿，百般順意自安然。',
        '{xx.yi}':
          '翼星不利架高堂，三年二載見瘟惶，埋葬若還逢此日，子孫必定走他鄉，婚姻此日不宜利，歸家定是不相當，開門放水家須破，少女戀花貪外郎。',
        '{xx.zhen}':
          '軫星臨水造龍宮，代代為官受皇封，富貴榮華增壽祿，庫滿倉盈自昌隆，埋葬文昌來照助，宅舍安寧不見兇，更有為官沾帝寵，婚姻龍子入龍宮。',
      },
      ZHENG: {
        '{xx.jiao}': '{wx.mu}',
        '{xx.jing}': '{wx.mu}',
      ...
      getXunIndex: function (ganZhi) {
        var diff =
          this.find(ganZhi, this.GAN).index - this.find(ganZhi, this.ZHI).index;
        if (diff < 0) {
          diff += 12;
        }
  ...
  var HolidayUtil = (function (_NAMES) {
    ...
    var _ymd = function (s) {
      return s.indexOf('-') < 0
        ? s.substring(0, 4) + '-' + s.substring(4, 6) + '-' + s.substring(6)
        : s;
    };
      ...
      while (data.length >= _SIZE) {
        ...
        if (!holiday) {
          ...
          if (nameIndex > -1) {
            ...
            _DATA_IN_USE = _DATA_IN_USE.replace(
              new RegExp(old, 'g'),
              remove ? '' : segment
            );
          }
  ...
  var NineStar = (function () {
    ...
    return {
      ...
      SONG_TAI_YI: [
        '門中太乙明，星官號貪狼，賭彩財喜旺，婚姻大吉昌，出入無阻擋，參謁見賢良，此行三五里，黑衣別陰陽。',
        '門前見攝提，百事必憂疑，相生猶自可，相克禍必臨，死門並相會，老婦哭悲啼，求謀並吉事，盡皆不相宜，只可藏隱遁，若動傷身疾。',
        '出入會軒轅，凡事必纏牽，相生全不美，相克更憂煎，遠行多不利，博彩盡輸錢，九天玄女法，句句不虛言。',
        '招搖號木星，當之事莫行，相克行人阻，陰人口舌迎，夢寐多驚懼，屋響斧自鳴，陰陽消息理，萬法弗違情。',
        '五鬼為天符，當門陰女謀，相克無好事，行路阻中途，走失難尋覓，道逢有尼姑，此星當門值，萬事有災除。',
        '神光躍青龍，財氣喜重重，投入有酒食，賭彩最興隆，更逢相生旺，休言克破兇，見貴安營寨，萬事總吉同。',
        '吾將為鹹池，當之盡不宜，出入多不利，相克有災情，賭彩全輸盡，求財空手回，仙人真妙語，愚人莫與知，動用虛驚退，反覆逆風吹。',
        '坐臨太陰星，百禍不相侵，求謀悉成就，知交有覓尋，回風歸來路，恐有殃伏起，密語中記取，慎乎莫輕行。',
        '迎來天乙星，相逢百事興，運用和合慶，茶酒喜相迎，求謀並嫁娶，好合有天成，禍福如神驗，吉兇甚分明。',
      ],
      LUCK_QI_MEN: [
        '大兇',
        '大兇',
    ...
    var _fromLunar = function (lunar) {
      return {
        ...
        getMingGong: function () {
          var monthZhiIndex = LunarUtil.index(
            this.getMonthZhi(),
            LunarUtil.MONTH_ZHI,
            0
          );
          var timeZhiIndex = LunarUtil.index(
            this.getTimeZhi(),
            LunarUtil.MONTH_ZHI,
            0
          );
          ...
          var ganIndex =
            (this._p.lunar.getYearGanIndexExact() + 1) * 2 + offset;
          while (ganIndex > 10) {
            ganIndex -= 10;
          }
        ...
        getShenGong: function () {
          ...
          var ganIndex =
            (this._p.lunar.getYearGanIndexExact() + 1) * 2 + (offset % 12);
          while (ganIndex > 10) {
            ganIndex -= 10;
          }
          return LunarUtil.GAN[ganIndex] + LunarUtil.MONTH_ZHI[offset];
        ...
        getYun: function (gender, sect) {
          ...
          var start = (function () {
            ...
            if (2 === sect) {
              ...
              var startTimeZhiIndex =
                start.getHour() === 23
                  ? 11
                  : LunarUtil.getTimeZhiIndex(
          ...
          var buildLiuYue = function (liuNian, index) {
            return {
              ...
              getGanZhi: function () {
                var yearGanIndex =
                  LunarUtil.find(this._p.liuNian.getGanZhi(), LunarUtil.GAN)
                    .index - 1;
              ...
              getGanZhi: function () {
                var offset =
                  LunarUtil.getJiaZiIndex(
                    this._p.lunar
                      .getJieQiTable()
                      [I18n.getMessage('jq.liChun')].getLunar()
    ...
    var _fromYmdHms = function (
      ...
      return {
        ...
        getNineStar: function () {
          ...
          var index = asc
            ? start + this._p.zhiIndex
            : start + 9 - this._p.zhiIndex;
          return NineStar.fromIndex(index % 9);
        },
        getXun: function () {
          return LunarUtil.getXun(this.getGanZhi());
  ...
  var FotoUtil = (function () {
    ...
    return {
      ...
      FESTIVAL: {
        ...
        '3-16': [_f('準提菩薩誕', dj)],
        '3-19': [_f('中岳大帝誕'), _f('後土娘娘誕'), _f('三茅降')],
        '3-20': [_f('天地倉開日', ss), _f('子孫娘娘誕')],
        '3-23': [_t],
        '3-25': [_h],
        '3-27': [_f('七殿泰山王誕'), _d],
        '3-28': [_r, _f('蒼頡至聖先師誕', xl), _f('東岳大帝誕')],
        '3-29': [_t],
        '3-30': [_hh, _m, _t],
        '4-1': [_f('八殿都市王誕', dj), _s],
        '4-3': [_d],
        ...
        '8-1': [_s, _f('許真君誕')],
        '8-3': [_d, _f('北鬥誕', xl), _f('司命竈君誕', '犯者遭回祿')],
        '8-5': [_f('雷聲大帝誕', dj)],
        '8-6': [_l],
        '8-8': [_t],
        '8-10': [_f('北鬥大帝誕')],
        ...
        '9-1': [
          _s,
          _f('南鬥誕', xl),
          _f('北鬥九星降世', dj, false, '此九日俱宜齋戒'),
        ],
        '9-3': [_d, _f('五瘟神誕')],
        '9-6': [_l],
        '9-8': [_t],
        '9-9': [_f('鬥母誕', xl), _f('酆都大帝誕'), _f('玄天上帝飛升')],
        '9-10': [_f('鬥母降', dj)],
        '9-11': [_f('宜戒')],
        '9-13': [_f('孟婆尊神誕')],
        '9-14': [_t],
        ...
        '9-19': [_f('日宮月宮會合', js), _f('觀世音菩薩誕', js)],
        '9-23': [_t],
        '9-25': [_h, _y],
        '9-27': [_d],
        '9-28': [_r],
        ...
        '10-1': [_s, _f('民歲臘', dj), _f('四天王降', '犯者一年內死')],
        '10-3': [_d, _f('三茅誕')],
        '10-5': [_f('下會日', js), _f('達摩祖師誕', js)],
        '10-6': [_l, _f('天曹考察', dj)],
        '10-8': [_f('佛涅槃日', '', false, '大忌色欲'), _t],
        '10-10': [_f('四天王降', '犯者一年內死')],
        '10-11': [_f('宜戒')],
        '10-14': [_f('三元降', js), _t],
        ...
        '11-17': [_f('阿彌陀佛誕')],
        '11-19': [_f('太陽日宮誕', '犯者得奇禍')],
        '11-21': [_y],
        '11-23': [_f('張仙誕', '犯者絕嗣'), _t],
        '11-25': [_f('掠刷大夫降', '犯者遭大兇'), _h],
        '11-26': [_f('北方五道誕')],
        '11-27': [_d],
        '11-28': [_r],
        '11-29': [_t],
    ...
    var _fromLunar = function (lunar) {
      return {
        ...
        getOtherFestivals: function () {
          var l = [];
          var fs =
            FotoUtil.OTHER_FESTIVAL[this.getMonth() + '-' + this.getDay()];
          if (fs) {
            l = l.concat(fs);
          }
          return l;
  ...
  var TaoUtil = (function () {
    ...
    return {
      ...
      FESTIVAL: {
        ...
        '3-18': [_f('王祖(王處一)玉陽真人聖誕'), _f('後土娘娘聖誕')],
        '3-19': [_f('太陽星君聖誕')],
        '3-20': [_f('子孫娘娘聖誕')],
        '3-23': [_f('天後媽祖聖誕')],
        '3-26': [_f('鬼谷先師誕')],
        ...
        '6-26': [_f('二郎真君聖誕')],
        '7-7': [
          _f('道德臘之辰', '道德臘，此日五帝會於西方七炁素天'),
          _f('慶生中會', '此日中元赦罪，地官同天水二官考校罪福'),
        ],
        '7-12': [_f('西方雷祖聖誕')],
        '7-15': [_f('中元地官大帝聖誕')],
        '7-18': [_f('王母娘娘聖誕')],
        ...
        '11-11': [_f('太乙救苦天尊聖誕')],
        '11-26': [_f('北方五道聖誕')],
        '12-8': [_f('王侯臘之辰', '王侯臘，此日五帝會於上方玄都玉京')],
        '12-16': [_f('南岳大帝聖誕'), _f('福德正神誕')],
        '12-20': [_f('魯班先師聖誕')],
        '12-21': [_f('天猷上帝聖誕')],
        '12-22': [_f('重陽祖師聖誕')],
        '12-23': [_f('祭竈王', '最適宜謝舊年太歲，開啟拜新年太歲')],
        '12-25': [_f('玉帝巡天'), _f('天神下降')],
        '12-29': [_f('清靜孫真君(孫不二)成道')],
      },
    };
  })();
    ...
    var _fromLunar = function (lunar) {
      return {
        ...
        isDayTianShe: function () {
          ...
          if (
            [
              I18n.getMessage('dz.yin'),
              I18n.getMessage('dz.mao'),
              I18n.getMessage('dz.chen'),
            ]
              .join(',')
              .indexOf(mz) > -1
          ) {
            ...
            [
              I18n.getMessage('dz.si'),
              I18n.getMessage('dz.wu'),
              I18n.getMessage('dz.wei'),
            ]
              .join(',')
              .indexOf(mz) > -1
          ) {
            ...
            [
              I18n.getMessage('dz.shen'),
              I18n.getMessage('dz.you'),
              I18n.getMessage('dz.xu'),
            ]
              .join(',')
              .indexOf(mz) > -1
          ) {
            ...
            [
              I18n.getMessage('dz.hai'),
              I18n.getMessage('dz.zi'),
              I18n.getMessage('dz.chou'),
            ]
              .join(',')
              .indexOf(mz) > -1
          ) {
